...
% Get x-vectors with label 1 and compute mean and std. for each feature.
...
% Likelihood for class 1 & 2. Product of normal pdf of each feature.
like1 = prod(normpdf(Xtest, mu1, sigma1));
like2 = prod(normpdf(Xtest, mu2, sigma2));

% Compute probability for class 1 and 2. Classify xnew with label.
